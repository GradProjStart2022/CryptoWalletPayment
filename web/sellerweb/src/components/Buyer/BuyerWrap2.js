...
const BuyerWrap2 = () => {
  ...
  const showModalHandler = () => {
    window.open(
      `https://nanng.onrender.com/qrpage?sellerFlatform=${randomItem.sellerPlatform}&productName=${randomItem.productName}&productPrice=${randomItem.productPrice}&walletName=${randomItem.walletName}&walletContractAddress=${randomItem.walletContractAddress}&recieptNo=${receiptNo}&sellerId=${randomItem.sellerId}`,
      'PopupWin',
